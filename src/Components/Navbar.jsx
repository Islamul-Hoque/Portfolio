...
const Navbar = () => {
  return (
    <div className="navbar bg-gray-900 border- b border- gray-800 text-white shadow-sm px-4 md:px-14">
  <div className="navbar-start ">
    ...
    <a className="md:text-xl font-bold text-indigo-400"> <span> </span> Ishfak </a>
  </div>
